...
/// Size of any page in hinder-db, around 8KiB. We don't have true slotted page architecture,
...
mod tests {
    ...
    fn temp_db_path(test_name: &str) -> String {
        ...
        format!(
            "/Volumes/External T7/hinder_db_test_{}_{}.db",
            test_name, timestamp
        )
    }
    ...
    fn test_byte_cursor_primitives() {
        ...
        write_cursor.write_bytes(b"hinder-db");
        ...
        assert_eq!(read_cursor.read_bytes(9), b"hinder-db");
    }
